...
items_data = [
    ...
    {
        "name": "Mesh Floral Midi Skirt",
        "image_url": "https://img1.shopcider.com/product/1683293516000-BE6pDc.jpg?x-oss-process=image/resize,w_350,m_lfit/quality,Q_80/interlace,1",
        "imageAlt": "Mesh floral midi skirt",
        "description": "The cutest flowy skirt that goes with anything.",
        "category_name": "Clothing",
        "price": "$30.00",
    },
    {
